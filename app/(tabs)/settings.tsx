      ...
      <ScrollView className="flex-1">
        ...
        <View className="px-4 mb-6">
          ...
          <Text className="text-sm text-muted mb-3">
            Collez l'URL de votre emploi du temps depuis le site de votre université. Une URL par defaut est deja configuree.
          </Text>
          <View className="bg-green-500/10 rounded-lg p-3 mb-3">
            ...
            <Text className="text-green-600 text-xs mt-1">
              Note: Le service RSS est en erreur. Utilisez l'URL ICS.
            </Text>
          </View>
          <TextInput
            value={icsUrl}
        ...
        <View className="px-4 mb-6">
          <View className="bg-surface rounded-xl p-4">
            ...
            <Text className="text-sm text-muted">
              Application d'emploi du temps pour les étudiants
            </Text>
          </View>
        </View>
      </ScrollView>
